...
connected graph is, and Aouchiche et al \cite{AouchicheEtAl2008} conjectured that this extremal
...
In the remainder of the paper we prove Theorem~\ref{main_theorem}.
...
\endgroup
\end{center}
\caption{Structure of $G$ in Proposition \ref{almost pineapple structure}.  The number appearing beside
each set indicates the values of eigenvector entries within the set. 
$U$ induces a complete
graph and $V$, $W$ are independent sets.  Each vertex in $V$ is adjacent
